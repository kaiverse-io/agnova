...
evals/datasets/wikiann/<lang>.json so run_scale_eval_qortia_ner.py runs offline
...
# exercise the ner_lang_unsupported -> English-fallback path on genuinely
# non-English text rather than only ever testing the two designed-for routes.
